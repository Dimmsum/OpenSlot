          ...
          <div className="rounded-2xl border border-[hsl(240_4%_18%)] bg-[hsl(240_5%_11%)] p-8">
            ...
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-[hsl(0_0%_64%)]">
                Get started with OpenSlot — schedule smarter today.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  className="border-[hsl(240_4%_18%)] data-[state=checked]:bg-primary"
                />
                <label
                  htmlFor="terms"
                  className="text-sm text-[hsl(0_0%_64%)]"
                >
                  I agree to the{" "}
              ...
              <p className="text-center text-sm text-[hsl(0_0%_64%)]">
